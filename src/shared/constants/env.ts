...
export const env = {
  apiUrl: process.env.REACT_APP_USE_PROXY === 'true' ? window.location.origin : process.env.REACT_APP_SERVER,
  wsUrl: process.env.REACT_APP_USE_PROXY === 'true' ? window.location.origin.replace('http', 'ws') : process.env.REACT_APP_WS_SERVER,
