...
const templateData: TemplateData[] = [
  {
    ...
    content: [
      ...
      },
      {
        ...
        search:
          'is(aws_s3_bucket) and (bucket_public_access_block_configuration != null and (bucket_public_access_block_configuration.{block_public_acls != true or ignore_public_acls != true or block_public_policy != true or restrict_public_buckets != true})) or (bucket_acl.grants[*].{permission in [READ, READ_ACP] and grantee.uri = "http://acs.amazonaws.com/groups/global/AllUsers"}) or (bucket_policy.Statement[*].{Principal = "*" and (Action in [s3:GetObject, s3:PutObject] or Action[*] in [s3:GetObject, s3:PutObject])})',
      },
      {
