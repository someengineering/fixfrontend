...
describe('getAutoCompleteFromKey', () => {
  ...
  test('getAutocompleteValueFromKey should get autocomplete values from key with give items and no values and as array', () => {
    const cloudsResult = getAutocompleteValueFromKey(validKeys[0], items, null, true)
    const accountsResult = getAutocompleteValueFromKey(validKeys[1], items, '', true)
    const invalid = getAutocompleteValueFromKey('invalid', items, null, true)
    expect(cloudsResult.length).toBe(0)
    expect(accountsResult.length).toBe(0)
  ...
  test('getAutocompleteValueFromKey should get autocomplete values from key with give items and values and as array', () => {
    const cloudsResult = getAutocompleteValueFromKey(validKeys[0], items, '[clouds,clouds2]', true)
    const cloudsEmptyResult = getAutocompleteValueFromKey(validKeys[0], items, '[]', true)
    const accountsResult = getAutocompleteValueFromKey(validKeys[1], items, '[accounts]', true)
  ...
  test('getAutocompleteValueFromKey should get autocomplete values with new value from give items and values', () => {
    const cloudsResult = getAutocompleteValueFromKey(validKeys[0], items, 'clouds', false, true)
    const accountsResult = getAutocompleteValueFromKey(validKeys[1], items, 'something else', false, true)
    const invalid = getAutocompleteValueFromKey('invalid', items, 'invalid', false, true)
    expect(cloudsResult.value).toBe('clouds')
  ...
  test('getAutocompleteValueFromKey should get autocomplete values with new value from give items and values as array', () => {
    const cloudsResult = getAutocompleteValueFromKey(validKeys[0], items, '[clouds,clouds2,clouds3]', true, true)
    const cloudsResult2 = getAutocompleteValueFromKey(validKeys[0], items, '[clouds3]', true, true)
    const cloudsEmptyResult = getAutocompleteValueFromKey(validKeys[0], items, '[]', true, true)
    const accountsResult = getAutocompleteValueFromKey(validKeys[1], items, '[accounts,accounts2]', true, true)
    const invalid = getAutocompleteValueFromKey('invalid', items, '[invalid]', true, true)
